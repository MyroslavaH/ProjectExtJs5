...
folder are mapped to the application's root namespace, 'ProjectExtJs5'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "ProjectExtJs5"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'ProjectExtJs5' in the same way
as `"ProjectExtJs5/sass/src"`.
